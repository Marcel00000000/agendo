...
async function Adapter(client) {
  // Import Node modules dynamically to avoid Edge runtime issues
...
const pool = process.env.NEXT_RUNTIME === 'edge' ? null : new Pool({
      connectionString: process.env.DATABASE_URL,
    });
const adapter = process.env.NEXT_RUNTIME === 'edge' ? undefined : await Adapter(pool);
